...
# Label-free microscopy channels (canonical in ops_utils.data.naming)
from ops_utils.data.naming import LABELFREE_CHANNELS
...
# Re-export from ops_utils (canonical implementation)
from ops_utils.data.naming import get_channel_type
...
def get_full_segmentation_config(
    ...
    yaml_config = {}
    if experiment:
        all_configs = load_experiment_configs(experiment)
    ...
    yaml_detection_overrides = yaml_config.get("frangi", {}) or yaml_config.get("blob", {})
